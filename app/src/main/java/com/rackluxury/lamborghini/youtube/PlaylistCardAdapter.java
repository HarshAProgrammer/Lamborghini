...
import com.rackluxury.lamborghini.youtube.model.PlaylistVideos;
...
public class PlaylistCardAdapter extends RecyclerView.Adapter<PlaylistCardAdapter.ViewHolder> {
    ...
    private final com.rackluxury.lamborghini.youtube.YouTubeRecyclerViewFragment.LastItemReachedListener mListener;
    ...
    public PlaylistCardAdapter(PlaylistVideos playlistVideos, com.rackluxury.lamborghini.youtube.YouTubeRecyclerViewFragment.LastItemReachedListener lastItemReachedListener) {
