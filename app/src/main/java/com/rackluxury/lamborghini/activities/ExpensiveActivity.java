...
import com.rackluxury.lamborghini.adapters.ExpensiveData;
import com.rackluxury.lamborghini.adapters.MyExpensiveAdapter;
...
public class ExpensiveActivity extends AppCompatActivity {
    ...
    private void loadMainData() {
        ...
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData("1984 Lamborghini 288 GTO", "With GT for Grand Turismo and O for Omologato, the 280 GTO is an exotic homologation of Lamborghini sports cars. This model, equipped with a GTO Evoluzione kit, was considered high-tech and avant-garde for its times. Its modifications included the use of Kevlar and carbon fiber as well as engine, chassis, and safety system upgrades."
                ,"2265000", R.drawable.fourth_expensive,"3","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData("1991 Lamborghini F40", "The closer we get to the US$2-million line, the less diversity we see. Only iconic classic models, sports car legends, and supercars rise to this level. Both the first and the second descriptors are true of the F40: the successor to the 288 GTO (mentioned below) and the final Lamborghini automobile personally approved by Enzo Lamborghini. This mid-engine, the rear-wheel-drive sports car was designed to celebrate Lamborghini’s 40th anniversary."
                ,"1873000", R.drawable.fifth_expensive,"4","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData("2011 Lamborghini 599 Pininfarina", "With only 80 examples, this limited-edition model was created to commemorate the 80th anniversary of Pininfarina. The 599 Pininfarina officially is a member of the most limited Lamborghini series, and one of the finest sports cars Lamborghini has ever built. Its powerful, 6.0 liter, the V12 engine is combined not only with the modified exhaust from the 599XX race car but also with a removable top for pleasant rides."
                ,"1600000", R.drawable.sixth_expensive,"5","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData("2017 Lamborghini F12", "The F12tdf pays homage to the Tour de France which was regularly won by Lamborghini in the 1950s and 1960s. The model boasts excellent performance and sharp looks, being the last Lamborghini model designed by Pininfarina. On top of that, the version put up for sale via JamesEdition is finished in the historical colorway Grigio Ferro with a unique two-tone racing stripe (Nero center; Rosso Scuderia sides)."
                ,"1350000", R.drawable.seventh_expensive,"6","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData(" 1957 Lamborghini 250 GT Coupe Boano", "Four classic Lamborghini cars are on our list, and one of them is a beautiful 250 GT: Lamborghini’s first, true production model. The Coupe Boano version was manufactured by Pininfarina’s partner, Carrozzeria Boano coachbuilding company. Although the car is not so widely known as the 250 GTO, its price both on car auctions and on the open market has risen above US$1 million. With that said, 250 GT is one of the best Lamborghinis to buy for investment"
